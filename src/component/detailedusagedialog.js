...
import DetailedUsageTable from './detailedusagetable.js';
  ...
  render() {
    ...
    return (
      <Dialog onClose={this.handleClose} aria-labelledby="simple-dialog-title" {...other}>
        ...
        <div>
            <DetailedUsageTable data={this.props.data}/>
        </div>
      </Dialog>
    );
  }
...
class DetailedUserReportDialog extends React.Component {
    state = {
        open: false,
        userUsages: [],
    };
  ...
  render() {
    return (
      <div>
        <Button variant="outlined"  onClick={this.handleClickOpen}>Detailed Report</Button>
...
export default DetailedUserReportDialog;